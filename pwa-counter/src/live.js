...
export async function createLiveMatch({ mode, players, variant = null, remote = false, options = null, timeoutMs = 1500 }) {
  try {
    ...
    return await Promise.race([
      apiPost('/live/matches', { mode, players, variant, remote, options }),
